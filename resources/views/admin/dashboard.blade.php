    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-6">
            <div class="bg-secondary text-center rounded p-4">
                ...
                <canvas id="myChart" height="170.4px; !important"></canvas>
            </div>
        </div>
        <div class="col-sm-12 col-xl-6">
            <div class="bg-secondary text-center rounded p-4">
                ...
                <canvas id="Graph" width="50vw" height="170.4px !important"></canvas>
            </div>
        </div>
    </div>
</div>
...
var myChart = new Chart(ctx, {
    ...
    options: {
        ...
        scales: {
            ...
            xAxes: [{
                gridLines: {
                    color: 'black' // Set the color of the vertical gridlines to black
                }
            }]
        },
        plugins: {
            // Use Chartist.js plugin to add axis titles
            chartist: {
                axisX: {
                    title: 'Month'
                },
        ...
        <div class="col-sm-12 col-md-6 col-xl-4">
            <div class="h-100 bg-secondary rounded p-4">
                ...
                <div class="d-flex mb-2">
                    <form action="{{route('todo')}}" method='post' style="display:flex;">
                        @csrf
...
// });
monthlyTotals.forEach(function(total) {
    totalData[total.month - 1] = total.total;
    subtotalData[total.month - 1] = total.subtotal; 
});
...
@if(Session::has('todoadd'))
    <script>
    toastr.success("Added to Cart Successfully!");
    </script>
    @endif
@if(Session::has('tododel'))
<script>
    toastr.error("Todo deleted successfully");
</script>
@endif
